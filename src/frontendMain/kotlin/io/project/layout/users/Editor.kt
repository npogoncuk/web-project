package io.project.layout.users
...
fun Container.editorPage(state: GLogState) {
            ...
            div(className = "row") {
                div(className = "col-md-10 offset-md-1 col-xs-12") {
                    if (isNewArticle || isMyArticle) {
                        ...
                        GLogManager.redirect(View.HOME)
                    }
                }
            }
        }
